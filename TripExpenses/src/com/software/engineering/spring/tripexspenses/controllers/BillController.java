...
//		getting business trips from current employee
...
//		summary - price
		BigDecimal summaryTBill = tbill.getSummary();
		summaryTBill = summaryTBill.subtract(bprice);
		tbill.setSummary(summaryTBill);
